...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "SquareDanceMain.py"
 
        #Name of program
        self.project_name = "Square Dance"
 
        #Project url
        self.project_url = "about:none"
 
        #Version of program
        self.project_version = "0.1 Alpha"
 
        #License of the program
        self.license = "DO WHAT EVER THE FUCK YOU WANT"
 
        #Auhor of program
        self.author_name = "Lee Jacobs"
        self.author_email = "leeJacobs@gmail.com"
        self.copyright = "Copyright (c) 2013 Lee Jacobs."
 
        #Description
        self.project_description = "A simple lumines clone with extendable skin features"
        ...
        self.extra_scripts = ['SquareDanceController','SquareDanceFactory','SquareDanceMap','SquareDanceView','SquareDanceBlock','SquareEventManager','SquareDanceState','SquareDanceBar']
